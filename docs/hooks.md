...
```sh
echo claude > /home/liaix/pjs/openboard/.ob-agent
echo designer > /home/liaix/pjs/openboard/.ob-role
```

## Other TUIs (graceful degradation)
- If the TUI has a per-prompt / pre-run hook, point it at `bash /home/liaix/pjs/openboard/bin/board-hook sync`
